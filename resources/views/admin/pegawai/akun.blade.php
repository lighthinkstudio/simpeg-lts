									...
									<div class="row align-items-center p-3">
										...
										<div class="col-md-9">
											...
											<span>
												...
												<small><span class="badge badge-pill badge-success text-uppercase">{{ $data->status }}</span></small>
												@elseif($data->status == 'inactive')
												<small><span class="badge badge-pill badge-danger text-uppercase">{{ $data->status }}</span></small>
												@else
												<small><span class="badge badge-pill badge-warning text-uppercase text-white">{{ $data->status }}</span></small>
												@endif
											</span><br>
